...
public:
  ...
  bool puzzleSolver()
  {
    ...
    else
    {
      ...
      // std::cout<<"focus pos "<<focus->position.first<<","<<focus->position.second<<"  deleted pos "<<gridMap[emptyGrids[indexes[rand]].first][emptyGrids[indexes[rand]].second].position.first<<","<<gridMap[emptyGrids[indexes[rand]].first][emptyGrids[indexes[rand]].second].position.second<<std::endl;
